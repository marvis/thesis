...
A \emph{snake} in the image is a lot of discrete points, which is called a spline.
\begin{equation}
v_s = (x_s, y_s)
\end{equation}
...
\end{figure}
\section{My work} \label{seg:imgseg-mywork}
